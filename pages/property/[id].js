...
const PropertyDetails = ({ PropertyDetails: { price, rentFrequency, rooms, agency, title, baths, area, isVerified, description, type, purpose, furnishingStatus, amenities, photos } }) => (
